...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../RealTimePizzaApp/node_modules/process/browser.js */ "./node_modules/process/browser.js")))
...
function initAdmin(socket) {
  // const orderTableBody = document.querySelector('#orderBodyTable')
  // let orders = []
  // let markup
  var orderTableBody = document.querySelector('#orderTableBody');
  var orders = [];
  var markup; //use for ajax calls
...
function updateStatus(order) {
  ...
  statuses.forEach(function (el) {
    ...
    if (data === order.status) {
      ...
      el.appendChild(time);
      if (el.nextElementSibling) el.nextElementSibling.classList.add('curr');
    }
  });
}

updateStatus(order);
var socket = io(); //admin file

Object(_admin__WEBPACK_IMPORTED_MODULE_0__["default"])(socket); // Join

if (order) {
  socket.emit('join', "order_".concat(order._id));
}

var adminAreaPath = window.location.pathname; //it gives url 
...
__webpack_require__(/*! D:\RealTimePizzaApp\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\RealTimePizzaApp\resources\scss\app.scss */"./resources/scss/app.scss");
